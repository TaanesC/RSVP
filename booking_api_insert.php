...
$sql = "insert into tbl_order (event, price, qty, full-name, contact, email, address) values ('$event', '$price', '$qty', '$customer_name', '$customer_contact', '$customer_email', '$customer_address' )";
